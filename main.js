...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const translations = {
        ...
        ar: {
            ...
            'hero-description': 'مرحباً، أنا معتز ضاحي عبد الرؤوف، مهندس ذكاء اصطناعي متخصص في تعلم الآلة، الرؤية الحاسوبية، معالجة اللغات الطبيعية، الذكاء الاصطناعي التوليدي، أنظمة RAG، الذكاء الاصطناعي الوكيل، والأتمتة الذكية.',
            'hero-view-work': 'شاهد أعمالي',
            'hero-download-cv': 'تحميل السيرة الذاتية',
            'cv-modal-title': 'السيرة الذاتية (CV)',
            'cv-modal-subtitle': 'عرض وتحميل السيرة الذاتية لمعتز داهي. شكراً لاهتمامك!',
            'cv-download-btn': 'تحميل',
            'cv-fallback-text': 'معاينة PDF غير مدعومة في متصفحك.',
            ...
            'proj-desc-1': 'نظام كشف لوحات السيارات في الوقت الفعلي باستخدام تقنيات الرؤية الحاسوبية لتحديد المركبات آلياً وإدارة مواقف السيارات.',
            ...
            'proj-desc-3': 'نظام تحليل مشاعر قائم على معالجة اللغات الطبيعية لبيانات تويتر، يُظهر مهام معالجة اللغة الطبيعية وتصنيف النصوص.',
            ...
            'proj-title-6': 'روبوت محادثة تليغرام مع n8n',
            'proj-desc-6': 'روبوت محادثة ذكي على تليغرام مبني بمنصة أتمتة n8n، يُظهر الذكاء الاصطناعي للمحادثة وأتمتة سير العمل.',
            ...
            'proj-desc-8': 'مجموعة من 7 أدوات استخراج للكتب والدورات وقوائم الوظائف والمباريات الرياضية وقوائم السيارات وغيرها، تُظهر مهام استخراج البيانات ومعالجتها.',
            ...
            'proj-desc-11': 'مشاريع تحليل بيانات شاملة تُظهر مهام معالجة البيانات والتصور والتحليل الإحصائي باستخدام Python وPandas.',
            ...
            'contact-location-text': 'القاهرة، مصر (ت ع م+2)',
            ...
            'footer-copyright': '© 2024 معتز عبد الرؤوف. جميع الحقوق محفوظة.',
